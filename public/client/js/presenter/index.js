...
var dispatch = __webpack_require__("df45").dispatch;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"432e15ac-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Cloud.vue?vue&type=template&id=8e9397e0&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"wordCloud",staticClass:"wordCloud"})}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Cloud.vue?vue&type=template&id=8e9397e0&
...
var src = __webpack_require__("df45");
...
var emptyOn = Object(src["dispatch"])("start", "end", "interrupt");
var emptyTween = [];
...
function onFunction(id, name, listener) {
  var on0, on1, sit = on_start(name) ? schedule_init : set;
  return function() {
...
function brush_brush(dim) {
  var extent = defaultExtent,
      ...
      listeners = Object(src["dispatch"])(brush, "start", "brush", "end"),
      handleSize = 6,
      touchending;
...
/* harmony default export */ var src_simulation = (function(nodes) {
  var simulation,
      ...
      forces = src_map(),
      stepper = timer(step),
      event = Object(src["dispatch"])("tick", "end");
...
/* harmony default export */ var d3_zoom_src_zoom = (function() {
  var filter = zoom_defaultFilter,
      ...
      gestures = [],
      listeners = Object(src["dispatch"])("start", "zoom", "end"),
      touchstarting,
      touchending,
      touchDelay = 500,
      wheelDelay = 150,
...
var d3_cloud = __webpack_require__("4a83");

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Cloud.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Cloudvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    onWordClick: {
      type: Function,
      default: function _default(word) {
        window.alert("You clicked ".concat(word.text));
      }
    },
    rotate: {
  ...
  methods: {
    createCanvas: function createCanvas() {
      var wordCounts = this.data.map(function (text) {
        return _objectSpread({}, text);
      });
      src_select(this.$el).selectAll('*').remove();
      var layout = d3_cloud().size([this.width, this.height]).words(wordCounts).padding(this.padding).spiral(this.spiral).rotate(this.rotate).font(this.font).fontSize(this.fontSizeMapper).on('end', this.end);
      if (this.colors) this.fill = ordinal().range(this.colors);else this.fill = ordinal(category10);
      layout.start();
    },
    end: function end(words) {
      var _this = this;
      ...
      src_select(this.$el).append('svg').attr('width', this.width).attr('height', this.height).append('g').attr('transform', "translate(".concat(this.width / 2, ",").concat(this.height / 2, ")")).selectAll('text').data(words).enter().append('text').style('font-family', function (d) {
        return d.font;
      }).style('font-size', function (d) {
        return "".concat(d.size, "px");
      }).style('fill', _fill).attr('text-anchor', 'middle').attr('transform', function (d) {
        return "translate(".concat([d.x, d.y], ")rotate(").concat(d.rotate, ")");
      }).text(function (d) {
        return d.text;
      }).on('click', function (d) {
        return _this.onWordClick(d);
      });
    }
  }
});
// CONCATENATED MODULE: ./src/components/Cloud.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Cloudvue_type_script_lang_js_ = (Cloudvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/components/Cloud.vue
...
var component = normalizeComponent(
  components_Cloudvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var Cloud = (component.exports);
// CONCATENATED MODULE: ./src/components/index.js


/* harmony default export */ var components = (Cloud);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js
/* concated harmony reexport Cloud */__webpack_require__.d(__webpack_exports__, "Cloud", function() { return Cloud; });
